    ...
    <Layout>
      ...
      <div className="container mx-auto px-6 py-2 sm:px-6 md:px-6 lg:px-32 xl:py-0">
        ...
        <div className='container flex justify-between my-4'>
          ...
          <Button id='next-lesson' customClass='bg-violet-600 text-white-200' onClick={nextLesson}>Próxima lição</Button>
        </div>
      </div>
              ...
              <div key={l?.section + l?.lesson}>
                ...
                <div className='flex justify-center'>
                  {lessonSent ?
                    ...
                    :
                    <Button ref={ref} id='submit-lesson' customClass='w-2/3 my-8 mx-auto' onClick={() => setOpen(true)}>{submissionTitle}</Button>
                  }
                  {open &&
                    <Modal
                      openExternal={open}
