function template(params) {
    ...
    <div><br></div>
    <div><b>O material do bootcamp será aberto oficialmente as 19h, junto com a live <a href="https://bootcamp.web3dev.com.br/courses/${params.cohort.course_id}">aqui</a>&nbsp;</div>
    <div>
    <div><br></div>
