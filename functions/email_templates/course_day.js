...
function template(params) {
  return `
    ...
    )}, você terá direito a receber um <b> NFT exclusivo </b>. Você também será adicionado ao cargo 🎓 graduad@ no nosso Discord e terá acesso a vagas de trabalho web3 em nossos parceiros.</div>
    <div><br></div>
    <div>2. Esse é o único e-mail que eu vou mandar. O resto estará acontecendo no canal secreto "#⛺ | ${
      params.cohort.discord_channel
    }" que você terá acesso caso esteja inscrito no bootcamp. Para isso, você precisa "linkar" seu Discord na plataforma de bootcamp antes de começar o projeto!
    </div>
    <div><br></div>
